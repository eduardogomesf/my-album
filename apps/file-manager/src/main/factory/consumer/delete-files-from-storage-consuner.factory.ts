...
export const generateDeleteFilesFromStorageConsumer = async (
  dependencies: UseCases,
): Promise<DeleteFilesFromStorageEventConsumer> => {
  ...
  const deleteFilesFromStorageEventConsumer =
    new DeleteFilesFromStorageEventConsumer(
      dependencies.deleteFilesFromStorageUseCase,
      kafkaConsumer,
    )
