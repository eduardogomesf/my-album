...
export const generateAddNewUserConsumer = async (
  useCases: UseCases,
): Promise<AddNewUserEventConsumer> => {
  ...
  const addNewUserEventConsumer = new AddNewUserEventConsumer(
    useCases.addNewUserUseCase,
    kafkaConsumer,
  )
