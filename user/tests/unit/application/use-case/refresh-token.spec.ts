...
describe('Refresh Token Use Case', () => {
  ...
  it('should successfully refresh token', async () => {
    ...
    const deleteByIdSpy = jest.spyOn(mockDeleteRefreshTokenByIdRepository, 'delete')
  ...
  it('should not refresh token if the token does not exist', async () => {
    mockGetRefreshTokenByTokenAndUserIdRepository.getByTokenAndUserId = jest.fn().mockResolvedValueOnce(null)
  ...
  it('should pass along any error that occurs', async () => {
    mockUserExistsRepository.exists = jest.fn().mockRejectedValueOnce(new Error('any_error'))
